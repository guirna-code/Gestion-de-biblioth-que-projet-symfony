 ...
 */
final class Version20251231150857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt ADD utilisateur_id INT NOT NULL, DROP utilisateur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt ADD utilisateur VARCHAR(10) NOT NULL, DROP utilisateur_id');
